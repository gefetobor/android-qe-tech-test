...
export class XCUITestDriver extends BaseDriver<{
    ...
    readonly disableAutomaticScreenshots: {
        readonly isBoolean: true; /** @type {string[]} */
    };
    ...
    static executeMethodMap: {
        ...
        readonly 'mobile: installCertificate': {
            ...
            readonly params: {
                readonly required: readonly ["content"];
                readonly optional: readonly ["commonName", "isRoot"]; /** @type {import('./commands/performance').PerfRecorder[]} */
            };
        };
        readonly 'mobile: removeCertificate': {
            readonly command: "mobileRemoveCertificate"; /** @type {LRUCache} */
            readonly params: {
